...
}else if(request.getParameter("page").toString().equals("res")){
    if(request.getParameter("operation").toString().equals("show")){
    	System.out.println("yes");
    	String us=request.getParameter("uid");
    	System.out.println(us);
    	session.setAttribute("nuid",us);
    	System.out.println("yes");
    	System.out.println("adm-page.jsp?pgprt=5&uid="+us);
    	System.out.println("yes");
        response.sendRedirect("adm-page.jsp?pgprt=5&uid="+us);
    }
