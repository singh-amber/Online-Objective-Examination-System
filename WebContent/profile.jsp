<%@page import="myPackage.classes.User"%> <%@page import="java.util.ArrayList"%>
<jsp:useBean id="pDAO" class="myPackage.DatabaseClass" scope="page" />
// this user is the user that has logged in <% User
user=pDAO.getUserDetails(session.getAttribute("userId").toString());
  ...
  <div class="panel" style="float: left; max-width: 600px">
    ...
    <div class="content-area">
      <div class="panel" style="float: left; max-width: 600px">
        ...
        <div class="profile">
          <h2>
            <span class="tag">Your Name</span><span
        ...
        <div
          class="central-div form-style-6"
